  ...
  var gameStats = {
    ...
    createGameSpace: function() {
      ...
      this.consoleArr.forEach(function(space) {
        if (space === "_") {
          consoleGameArr += "<div class='letter_space'><img class='blank_space' src='assets/images/eclipse.png' alt='telescope'height='100' width='77' /></div>";
        } else {
    ...
    displayAnswer: function() {
      function createAnswer() {
        ...
        gameStats.chosenWord.forEach(function(space) {
          answer += "<div class='letter_space correct-letter'>" + space.toUpperCase() + "</div>";
        });
        return answer;
      }
  ...
  var gameElements = {
    ...
    displayAnswer: function() {
      function createAnswerHTML() {
        var answerHTML = "";
        gameStats.chosenWord.forEach(function(space) {
          answerHTML += "<div class='letter_space correct-letter'>" + space.toUpperCase() + "</div>";
        });
        return answerHTML;
      }
